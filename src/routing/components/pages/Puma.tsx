import pumaModel1 from '../../../routing/assets/puma/kedy-puma-suede-classic-xxi-374915-01-20-1000x800.jpg'
import pumaModel2 from '../../../routing/assets/puma//krossovki-puma-trinity-open-road-393361-02-3-1000x800.jpg'
import pumaModel3 from '../../../routing/assets/puma/krossovki-puma-trinity-mid-hybrid-leather-393985-02-3-1000x800.jpg'
    ...
    return (
        <div>
            ...
            <div className={s.imgBlock}>
                {pumaArr.map((mod, index) => (
                    <Link to={`/PUMA/${mod.model}`} key={index}>
                        <img className={s.imgAdidas} src={mod.picture} alt={mod.collection} />
                    </Link>
                ))}
            </div>
