        ...
        <div>
           <h2> ADIDAS</h2>
            ...
            <div className={s.imgBlock}>
                {adidasArr.map((mod, index) => (
                    <Link key={index} to={`/adidas/${mod.id}`}>
                        <img className={s.imgAdidas} src={mod.picture} alt={mod.model}/>
                    </Link>
            ...
            {/*<ul className={s.imgBlock}>*/}
            {/*    <li><img className={s.imgAdidas} src={adidasArr[0].picture} alt=""/></li>*/}
            {/*    <li><img className={s.imgAdidas} src={adidasArr[1].picture} alt=""/></li>*/}
            {/*    <li><img className={s.imgAdidas} src={adidasArr[2].picture} alt=""/></li>*/}
            {/*</ul>*/}
